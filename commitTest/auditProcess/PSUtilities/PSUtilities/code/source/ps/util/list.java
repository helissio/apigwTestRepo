...

{
	...
	public static final void getItem (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(getItem)>> ---
		// @subtype unknown
	...
	public static final void getSubArray (IData pipeline)
        throws ServiceException
	{
	...
	public static final void sortDocumentListByKey (IData pipeline)
        throws ServiceException
	{

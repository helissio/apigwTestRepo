...

{
	...
	public static final void cacheLookup (IData pipeline)
	...
	public static final void getTable (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(getTable)>> ---
		// @subtype unknown
	...
	public static final void listTables (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(listTables)>> ---
		// @subtype unknown
	...
	public static final void lookupExists (IData pipeline)
        throws ServiceException
	{
	...
	public static final void lookupValue (IData pipeline)
        throws ServiceException
	{

...

{
	...
	static dataTypes _newInstance() { return new dataTypes(); }

	static dataTypes _cast(Object o) { return (dataTypes)o; }
	...
	public static final void convertFromString (IData pipeline)

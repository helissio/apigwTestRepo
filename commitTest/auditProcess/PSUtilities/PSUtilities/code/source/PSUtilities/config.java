        ...
        throws ServiceException
	{
		...
		while (st.hasMoreElements())
		{
		  ...
		  try
		  {
		    ...
		    {
		      // An extra getCanonicalFile call is needed here to get around a Java
		      // quirk
		    ...
		    // System.out.println("strCanonicalAllowedDir = " +
		    // strCanonicalAllowedDir);
		  }
		  catch (Exception e)
		  {
		  ...
		  if (fPath.isDirectory())
		  {
		    ...
		    if (strCanonicalDir != null && strCanonicalAllowedDir != null && fAllowedPath.isDirectory() && strCanonicalDir.equals(strCanonicalAllowedDir))
		    {
		      strValid = "true";
		      break;
		    }
		  ...
		  else
		  {
		    ...
		    if (fAllowedPath.isDirectory())
		    {
		      if (strCanonicalDir != null && strCanonicalAllowedDir != null && strCanonicalDir.equals(strCanonicalAllowedDir))
		      {
		        strValid = "true";
		        break;
		      }
		    ...
		    else
		    {
		      ...
		      if (strCanonicalDir != null && strCanonicalAllowedDir != null && strCanonicalDir.equals(strCanonicalAllowedDir) && strFilename.equals(strAllowedFilename))
		      {
		        strValid = "true";
		        break;
		      }

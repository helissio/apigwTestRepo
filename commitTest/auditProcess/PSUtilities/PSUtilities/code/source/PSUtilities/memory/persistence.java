...

{
        ...
        throws ServiceException
	{
		...
		else
		{
		  ...
		  System.out.println("Service: Util.memory.persistence:getDataFromMemory | " + "required parameter 'MemoryKey' missing");
		  return;
		}
		...
		{
		  // Print to standard output an error message and exit processing
		  System.out.println("Service: Util.memory.persistence:getDataFromMemory | " + "Unable to find 'MemoryKey' :" + strMemoryKey + " in Memory");
		  return;
		}
        ...
        throws ServiceException
	{
		...
		{
		  // Print to standard output an error message and exit processing
		  System.out.println("Service: Util.memory.persistence:removeDataFromMemory | " + "required parameter 'MemoryKey' missing");
		  return;
		}
		...
		{
		  // Print to standard output an error message and exit processing
		  System.out.println("Service: Util.memory.persistence:removeDataFromMemory | " + "Unable to get MemoryData for MemoryKey: " + strMemoryKey);
		  return;
		}
        ...
        throws ServiceException
	{
		...
		{
		  // Print to standard output an error message and exit processing
		  System.out.println("Service: Util.memory.persistence:saveDataToMemory | " + "required parameter 'MemoryKey' missing");
		  return;
		}
		...
		{
		  // Print to standard output an error message and exit processing
		  System.out.println("Service: Util.memory.persistence:saveDataToMemory | " + "Unable to get MemoryData for MemoryKey: " + strMemoryKey);
		  return;
		}
